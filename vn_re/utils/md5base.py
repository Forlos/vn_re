...
class MD5:
    ...
    def copy(self):
        """Returns a deep copy of this md5 object."""
    ...
    def __hash(self, message):
        ...
        for chunk in chunks:
            words = self.__createWordArray(
                chunk, messageLength, chunks.index(chunk) == len(chunks) - 1
            )
    ...
    def __toBinaryString(self, string):
        ...
        return "".join("{:08b}".format(byte) for byte in bytearray(string))
